...
// ============================================
// 🔥 DATA DE SENADORES (TITULARES + SUPLENTES)
// ============================================
const SENADORES_DATA = [
  ...
  { 
    ...
    suplente: null, slugSuplente: null, fotoSuplente: null
  },
  { 
...
async function seedAll() {
  ...
  try {
    ...
    console.log('   ✅ Todo los datos cargados correctamente');
    console.log('═'.repeat(80) + '\n');
